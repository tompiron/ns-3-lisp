...
/**
  ...
  */
  Ipv4DynamicNatTuple (Ipv4Address local, Ipv4Address global, uint16_t localport, uint16_t globalport);
...
/**
  *\return The local source port number of the host on NATed network
  */
  uint16_t GetLocalPort () const;
